        ...
        <Stack w={'100%'} alignItems={'center'} justifyContent={'center'} direction={{ base: 'column', md: 'column', lg: 'row' }}>
            ...
            <VStack w={{ base: '100%', md: '100%', lg: '50%' }} spacing={3}>
                ...
                <form style={{ width: '90%' }} onSubmit={formSubmit} >
                    ...
                    <Text textAlign={'center'} mt={'15px'} fontWeight={'400'} fontSize={['1.2rem','1.1rem','.9rem']}>Already have an Astrologer account? <NavLink to={'/astrologerlogin'} color={'green'} fontWeight={'900'} fontSize={['1.2rem','1.1rem','.9rem']}>Login</NavLink></Text>
                </form>
            </VStack>
        </Stack>
