    ...
    return (
        <>
            ...
            <form style={{ width: '100%', marginTop: '20px' }}>
                ...
                <Button colorScheme='whatsapp' mt='10px' size={'md'}>Post</Button>
            </form>
